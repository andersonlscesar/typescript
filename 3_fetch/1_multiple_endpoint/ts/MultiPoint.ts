...
type ArrayObj = Array<{url: string, arr: string, button_title: string}>;
...
class MultiPoint
{
    ...
    ****************************************/
    ...
    private buttonContainer: HTMLDivElement = document.querySelector('.button-container') as HTMLDivElement;
    ...
    *********************************************************/
    ...
    private info: HTMLDivElement = document.querySelector('.info') as HTMLDivElement;
    ...
    *************************************************/
    ...
    private readonly urls: ArrayObj = [
        {
    ...
    *****************************************************/
    ...
    private generateButtons(): void 
    {
        this.urls.forEach( (url, index) => {
            ...
            const newIndex = <unknown> index;
            button.classList.add('btn', 'btn-primary');
            button.textContent = url.button_title;
            button.setAttribute('index', newIndex as string);
    ...
    *********************************************/
    ...
    private addEvent(button: HTMLButtonElement): void 
    {
    ...
    *****************************************************/
    ...
    private async consumeAPI(e: MouseEvent): Promise<void>
    {
        try {
            const button = <HTMLButtonElement> e.target;
            const currentIndex = Number(button.getAttribute('index'));
            const response: Response = await fetch(this.urls[currentIndex].url);
    ...
    **********************************************************************************************************/
    ...
    private HTMLTemplate(obj: MainObj): void 
    {
        this.info.innerHTML = '';
        ...
        for(const d of data) {
            let title: string[] = Object.keys(d); // pegando apenas os titulos do objeto
        ...
        for(const d of data) {
            let values: string[] = Object.values(d);
